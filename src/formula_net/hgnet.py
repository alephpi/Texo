# This file implements HGNetV2 it is adapted from HGNet implementation https://github.com/frotms/PaddleOCR2Pytorch/blob/main/pytorchocr/modeling/backbones/rec_hgnet.py
# There are two different official implementations for PPHGNetV2:
# https://github.com/PaddlePaddle/PaddleDetection/blob/develop/ppdet/modeling/backbones/hgnet_v2.py
# and https://github.com/PaddlePaddle/PaddleOCR/blob/main/ppocr/modeling/backbones/rec_pphgnetv2.py
# where the latter inherits TheseusLayer from PaddleOCR, which is too complicated for me to understand
# and I suppose it's useless since the former inherits directly from nn.Layer.
# since V2 differs little from V1, so I will adapt it from V1, which has a more intelligible code base.
